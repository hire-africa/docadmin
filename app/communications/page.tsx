...
const NOTIFICATION_ICONS = [
  { name: 'bell', label: 'General', type: 'system', icon: Bell },
  ...
  { name: 'alert', label: 'Alert', type: 'system', icon: AlertTriangle },
  { name: 'info', label: 'Info', type: 'system', icon: Info },
  { name: 'success', label: 'Success', type: 'system', icon: CheckCircle },
  { name: 'health', label: 'Health', type: 'system', icon: Heart },
  { name: 'security', label: 'Security', type: 'system', icon: Shield }
];
